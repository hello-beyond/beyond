...
module.exports = class extends DynamicProcessor {
    ...
    static dependencies(distribution) {
        if (!global.platforms.webAndMobile.includes(distribution.platform)) return [];
        return ['@beyond-js/widgets/render/ts'];
    }
    ...
    _process() {
        ...
        code += !widgets.size ? '' :
            `const {widgets} = require('@beyond-js/widgets/render/ts');\n` +
