...
module.exports = new class {
    ...
    ready = async () => {
        ...
        const name = `ts-transpiler${is}.db`;
        ...
        await this.#run('CREATE TABLE IF NOT EXISTS ts_transpiler (' +
            'bundle_id TEXT NOT NULL, ' +
            'distribution NUMBER NOT NULL, ' +
            'language TEXT NOT NULL, ' +
            'data TEXT NOT NULL);');

        await this.#run('CREATE UNIQUE INDEX IF NOT EXISTS bundle_id_index ' +
            'on ts_transpiler (bundle_id, distribution, language);');
