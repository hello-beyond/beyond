...
module.exports = new class {
    ...
    ready = async () => {
        ...
        const name = `tsc-analyzer-bridges${is}.db`;
        ...
        await this.#run('CREATE TABLE IF NOT EXISTS bridges (' +
            'bundle_id TEXT NOT NULL, ' +
            'data TEXT NOT NULL);');

        await this.#run('CREATE UNIQUE INDEX IF NOT EXISTS bundle_id_index on bridges (bundle_id);');
