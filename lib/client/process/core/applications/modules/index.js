...
module.exports = class extends DynamicProcessor {
    ...
    // The modules in a map where the key is its resource id (not the PLM id) + //${platform}
    #resources = new Map();
    get resources() {
    ...
    _process() {
        ...
        updated.forEach(module => {
            ...
            module.platforms.forEach(platform => this.#resources.set(`${module.resource}//${platform}`, module));
        });
    }
