...
module.exports = async function (
    builder, module, distribution, path, uglifier, exports, externals
) {
    'use strict';
    ...
    for (const bundle of module.bundles.values()) {
        ...
        const build = async language => {
            await require(distribution.npm ? './bundles' : './bundle')('.js', path, module, bundle, distribution, language, uglifier, builder, exports, externals);
            await require('./bundle')('.css', path, module, bundle, distribution, language, uglifier, builder, exports, externals);
        };
