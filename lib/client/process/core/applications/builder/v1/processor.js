...
module.exports = class {
    ...
    async process() {
        ...
        await require('./externals')(builder, modules, paths);
        //OLD await (require('./externals'))(builder, distribution, paths.www);

        // Save the package.json
        if (distribution.npm || platforms.node.includes(platform)) {
            await (require('./package'))(modules, builder, paths, staticEntries, distribution.npm);
        }
