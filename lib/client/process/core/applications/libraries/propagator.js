module.exports = class {
    ...
    constructor(emitter) {
        ...
        this.#listeners.set('js.initialised', ({packager}) => {
        ...
        this.#listeners.set('css.initialised', ({packager}) => {
            const {bundle, distribution, language} = packager;
    ...
    subscribe = libraries => libraries.forEach(library => {
        ...
        library.bundles.on('js.initialised', listeners.get('js.initialised'));
        library.bundles.on('js.change', listeners.get('js.change'));
        library.bundles.on('css.initialised', listeners.get('css.initialised'));
    ...
    unsubscribe = libraries => libraries.forEach(library => {
        ...
        library.bundles.off('js.initialised', listeners.get('js.initialised'));
        library.bundles.off('js.change', listeners.get('js.change'));
        library.bundles.off('css.initialised', listeners.get('css.initialised'));
