...
module.exports = async function (baseDir, application, distribution) {
    ...
    if (application.engine !== 'legacy') {
        main.push('@beyond-js/widgets/render');
        main.push('@beyond-js/widgets/application');
        main.push('@beyond-js/widgets/layout');
    }
    else {
        main.push('@beyond-js/kernel/styles');
    }

    main.push(`${application.package}/start`);
    distribution.local && distribution.development.tools && main.push('@beyond-js/local/main');
