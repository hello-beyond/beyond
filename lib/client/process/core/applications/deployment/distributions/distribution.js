...
module.exports = class extends DynamicProcessor {
    ...
    constructor(config, local, key) {
        ...
        const platforms = ['web', 'backend', 'node'];
        config.platform = config.platform ? config.platform : 'web';
        this.#platform = platforms.includes(config.platform) ? config.platform : 'web';
        ...
        const cjs = ['backend', 'node'].includes(this.#platform);
