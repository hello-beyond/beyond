...
module.exports = class extends DynamicProcessor {
    ...
    _process(config) {
        ...
        let {platforms: def} = global;
        let platforms = config.platforms ? config.platforms : def.webAndMobile;
        platforms = typeof platforms === 'string' ? [platforms] : platforms;
        platforms = platforms instanceof Array ? platforms : def.webAndMobile;
        platforms = platforms.includes('*') ? def.all : platforms;

        platforms = new Set(platforms);
        platforms.has('web') && platforms.add('web.ssr');
        platforms.has('web.ssr') && platforms.add('ssr');
