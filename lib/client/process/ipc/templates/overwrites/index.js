module.exports = class {
    ...
    //TODO [@box bug pendiente]
    // el path esta viniendo solo hasta la raiz del overwrite,
    // no viene con la carpeta del modulo si por ejemplo esta especificada en el module.json
    async list(ids) {
