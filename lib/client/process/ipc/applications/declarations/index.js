...
const contextFile = '/client/bundles/processors/ts/compilers/tsc/context/context.txt';
...
module.exports = class {
    ...
    async #updateAll(application) {
        ...
        packagers.forEach(packager => {
            console.log('get', packager.declaration.id)
            promises.push(processDeclaration(packager.declaration))
        });
        await Promise.all(promises);
    };
