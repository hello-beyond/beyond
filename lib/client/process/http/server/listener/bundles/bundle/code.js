module.exports = async function (packager, bundle, resource, info, distribution, map) {
    'use strict';
    ...
    if (info) {
        ...
        const content = require('../sourcemap')(bundle, code.code(hmr), code.map(hmr), resource.extname, mode);
