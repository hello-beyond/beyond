...
module.exports = new class {
    ...
    #ProcessorAnalyzerDependencies = (require('./processor/dependencies'));
    get ProcessorAnalyzerDependencies() {
        return this.#ProcessorAnalyzerDependencies;
    }

    #ProcessorDependency = (require('./processor/dependencies/dependency'));
    get ProcessorDependency() {
        return this.#ProcessorDependency;
    }
