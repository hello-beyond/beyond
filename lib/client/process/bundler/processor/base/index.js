...
module.exports = class {
    ...
    constructor(name, specs) {
        ...
        if (meta.extender && (!meta.extender.Preprocessor || !meta.extender.Compiler)) {
            throw new Error(`Processor "${name}" error, extender specification is invalid. Preprocessor and Compiler are both required`);
        }
        ...
        this.#options = Options ? new Options(this, options) : void 0;
        ...
        Packager = meta.packager && !Packager && !meta.extender ? require('../packager') : Packager;
