...
module.exports = class extends DynamicProcessor {
    ...
    _process() {
        this.#diagnostics = this.#code = this.#hmr = void 0;
    }
    ...
    #code;
    get code() {
        return this.#code !== void 0 ? this.#code : (this.#code = this.#build(false));
    }

    #hmr;
    get hmr() {
        return this.#hmr !== void 0 ? this.#hmr : (this.#hmr = this.#build(true));
    }
