...
module.exports = class extends DynamicProcessor {
    ...
    get hash() {
        return this.children.get('hash').child;
    }

    // The last processed hash. Used to be able to compare it with the current hash of the processor
    ...
    constructor(container, hash, Dependency) {
        super();
        this.#container = container;
        this.#Dependency = Dependency ? Dependency : require('./dependency');
        this.#cache = new (require('./cache'))(container);
    ...
    _save() {
        this.#cache.save(this, this.#processedHash);
    }
