...
module.exports = class extends DynamicProcessor {
    ...
    constructor(transversal, distribution, language) {
        ...
        // The packagers of transversal bundle of the modules and libraries of the application
        const packagers = new (require('./packagers'))(this);

        this.#hash = packagers.hash;
        this.#dependencies = new (require('./dependencies'))(this, packagers);

        const specs = global.bundles.get(transversal.name);
        let TCP = specs.TransversalCodePackager;
        TCP = TCP ? TCP : require('./code');
        this.#code = new TCP(this, packagers);
    }
