...
exports.widgets = exports.hmr = exports.beyond = exports.WidgetSpecs = exports.WidgetControllerLoader = exports.SingleCall = exports.PendingPromise = exports.NodeWidget = exports.ModuleTexts = exports.Module = exports.ListenerFunction = exports.IWidgetStore = exports.IWidgetRendered = exports.Events = exports.Collection = exports.CancellationToken = exports.BundleStyles = exports.Bundle = exports.BeyondWidgetControllerSSR = exports.BeyondWidgetControllerBase = exports.BeyondWidgetController = exports.ActionsBridge = void 0;
...
exports.widgets = widgets;
exports.WidgetSpecs = WidgetSpecs;
exports.WidgetControllerLoader = WidgetControllerLoader;
exports.NodeWidget = NodeWidget;
exports.BeyondWidgetControllerSSR = BeyondWidgetControllerSSR;
...
exports.SingleCall = SingleCall;
exports.CancellationToken = CancellationToken;
exports.ListenerFunction = ListenerFunction;
exports.Events = Events;
exports.Collection = Collection;
exports.ActionsBridge = ActionsBridge;
exports.ModuleTexts = ModuleTexts;
...
__pkg.exports.process = function (require) {
  exports.beyond = beyond = require('./beyond').beyond;
  exports.Bundle = Bundle = require('./bundles/bundle').Bundle;
  exports.BundleStyles = BundleStyles = require('./bundles/styles/styles').BundleStyles;
  exports.Module = Module = require('./modules/module').Module;
  exports.ModuleTexts = ModuleTexts = require('./modules/texts').ModuleTexts;
  exports.ActionsBridge = ActionsBridge = require('./service/actions-bridge').ActionsBridge;
  exports.Collection = Collection = require('./utils/collection/collection').Collection;
  exports.Events = Events = require('./utils/events/events').Events;
  exports.ListenerFunction = ListenerFunction = require('./utils/events/types').ListenerFunction;
  exports.CancellationToken = CancellationToken = require('./utils/execution-control/cancellation-token/cancellation-token').CancellationToken;
  exports.SingleCall = SingleCall = require('./utils/execution-control/single-call/single-call').SingleCall;
  exports.PendingPromise = PendingPromise = require('./utils/pending-promise/pending-promise').PendingPromise;
  exports.IWidgetStore = IWidgetStore = require('./widgets/controller/base').IWidgetStore;
  exports.BeyondWidgetControllerBase = BeyondWidgetControllerBase = require('./widgets/controller/base').BeyondWidgetControllerBase;
  exports.BeyondWidgetController = BeyondWidgetController = require('./widgets/controller/controller').BeyondWidgetController;
  exports.IWidgetRendered = IWidgetRendered = require('./widgets/controller/ssr').IWidgetRendered;
  exports.BeyondWidgetControllerSSR = BeyondWidgetControllerSSR = require('./widgets/controller/ssr').BeyondWidgetControllerSSR;
  exports.NodeWidget = NodeWidget = require('./widgets/instances/node').NodeWidget;
  exports.WidgetControllerLoader = WidgetControllerLoader = require('./widgets/widget/loader').WidgetControllerLoader;
  exports.WidgetSpecs = WidgetSpecs = require('./widgets/widgets').WidgetSpecs;
  exports.widgets = widgets = require('./widgets/widgets').widgets;
};
