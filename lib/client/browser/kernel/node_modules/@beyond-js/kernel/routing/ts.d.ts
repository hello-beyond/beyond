...
declare namespace ns_config_config {
    ...
    class CRoutingConfig {
        #private;
        get layouts(): LayoutsConfig;
        get pages(): PagesConfig;
    }
    type RoutingConfig = CRoutingConfig;
    const config: CRoutingConfig;
}
...
declare namespace ns_pages_data {
    import URI = ns_uri_uri.URI;
    import IParents = ns_config_pages.IParents;
...
declare namespace ns_routing {
    import URI = ns_uri_uri.URI;
    import RoutingConfig = ns_config_config.RoutingConfig;
