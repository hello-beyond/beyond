...
declare namespace ns_beyond {
    ...
    class Beyond {
        ...
        get transversals(): {
            "__#17@#transversals": Map<string, ns_transversals_transversal.Transversal>;
        ...
        setup(config: IBeyondConfig): void;
        rpc: {
            prepare: () => void;
        };
...
declare namespace ns_bundles_instances_instances {
    ...
    class BundlesInstances extends Map<string, Bundle> {
        obtain(id: string, multilanguage: boolean, dependencies?: IDependencies): Bundle;
    }
...
// FILE: bundles/package/require/trace.d.ts
...
declare namespace ns_import_import {
    ...
    class BeyondImport {
        ...
        reload(module: string, version: number): Promise<any>;
        /**
         * Used to load an external AMD resource. Ex: socket.io is loaded using this method
         *
         * @param module {string} The module to be loaded
         */
        require(module: string): Promise<any>;
    }
}
...
declare namespace ns_modules_module {
    ...
    class Module {
        ...
        get id(): string;
        get bundles(): Bundles;
        get socket(): Promise<SocketIOClient.Socket>;
         ...
         * @param {string} txt The txt bundle specs if the module supports it
         */
        constructor(id: string, container?: Container, txt?: {
            id: string;
...
declare namespace ns_modules_modules {
    ...
    class Modules extends Map<string, Module> {
        ...
        get container(): Container;
        constructor(container?: Container);
        obtain(id: string): Module;
    }
}

// FILE: modules/texts.d.ts
...
declare namespace ns_service_service {
    ...
    abstract class Service {
        ...
        get socket(): Promise<SocketIOClient.Socket | undefined>;
...
declare namespace ns_transversals_bundle {
    ...
    class TransversalBundle {
        ...
        get created(): boolean;
        initialise(): void;
        constructor(transversal: Transversal, id: string, hash: number, creator: BundleWrapperFnc);
    }
}
...
// FILE: transversals/transversal.d.ts
...
// FILE: transversals/transversals.d.ts
declare namespace ns_transversals_transversals {
    import Transversal = ns_transversals_transversal.Transversal;
    import IDependencies = ns_bundles_instances_dependencies.IDependencies;
    const transversals: {
        "__#17@#transversals": Map<string, Transversal>;
        has(name: string, language: string): boolean;
...
// FILE: widgets/controller.d.ts
declare namespace ns_widgets_controller {
    import BeyondWidget = ns_widgets_widget.BeyondWidget;
...
// FILE: widgets/instances/node.d.ts
...
declare namespace ns_widgets_widget {
    import WidgetSpecs = ns_widgets_widgets.WidgetSpecs;
    import BeyondWidgetController = ns_widgets_controller.BeyondWidgetController;
    import NodeWidget = ns_widgets_instances_node.NodeWidget;
    const Element: {
        new (): HTMLElement;
...
export import BeyondWidgetController = ns_widgets_controller.BeyondWidgetController;
