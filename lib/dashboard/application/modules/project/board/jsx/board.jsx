export function ApplicationBoard(props) {
    ...
    const value = {
        application: controller.application, // @deprecated Application is a legacy name.
        project: controller.application, // project is the name to use instead of application.

        texts: controller.texts, displayView, setDisplayView, id
    }
