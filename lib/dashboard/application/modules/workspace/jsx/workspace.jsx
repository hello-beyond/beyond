export function DSWorkspace({workspace, animation}) {
    ...
    if (!workspace.ready || !ready) {
        ...
        return <PreloadWelcome setReady={setReady} animation={animation} workspace={workspace}/>
    }
