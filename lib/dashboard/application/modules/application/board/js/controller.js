const controller = new (class Controller extends ReactiveModel {
        ...
        get ready() {
            ...
            const models = !!this.application?.ready && !!Dashboard.ready
            // console.log(0.1, dependencies, module.texts.ready, monacoDependency, monacoDependency?.ready, models, this.currentId, this.application?.application?.id, this);
