class ApplicationModel extends ReactiveModel {
    ...
    _processTemplate() {
        //TODO: @julio TREE
        const {template: {application, processors}} = this.application;
        this._template.application = TreeFactory.get('template', [this.application, application, application.sources.items]);
