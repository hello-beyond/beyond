...
export class ModuleModel extends ReactiveModel {
        ...
        properties: {
            module: {
                ...
                properties: {
                    processors: {
                        properties: {
                            dependencies: true, sources: true, overwrites: true,
                        }
                    }
                }
            }
    ...
    checkLoaded() {
        ...
        if (this.am.module?.static) {
            const specs = {project: this.application, object: this.am, items: this.am.module.static.items};
    ...
    checkModule() {
        ...
        this.#bundlesTree = TreeFactory.get('module', {
            project: application, object: am, items: [...bundles.values()]
        });
