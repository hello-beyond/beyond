define(["exports", "@beyond-js/dashboard/core-components", "@beyond-js/kernel/bundle", "react", "react-dom"], function (_exports, _coreComponents, dependency_0, dependency_1, dependency_2) {
  "use strict";
  ...
  const __pkg = new __Bundle({
    "module": "@beyond-js/dashboard/layout-toolbar",
    "bundle": "code"
  }).package();
  ...
  **********/
  ...
  const legacyStyles = beyondLegacyStyles.register('@beyond-js/dashboard/layout-toolbar', '.dashboard-layout .ds-toolbar .group-items-toolbar .box-notifycation .dropdown{position:absolute;top:3.5rem;width:300px;transform:translateX(-90%);background-color:#242526;border:1px solid #474a4d;overflow:hidden}.dashboard-layout .ds-toolbar .group-items-toolbar .box-notifycation .dropdown .menu{width:100%}.dashboard-layout .ds-toolbar .group-items-toolbar .box-notifycation .dropdown .menu .menu-item{height:auto;text-decoration-line:none;display:flex;align-items:center;transition:background .5s;padding:1rem 1rem 0 1rem}.dashboard-layout .ds-toolbar .group-items-toolbar .box-notifycation .dropdown .menu .menu-item svg{height:3rem;width:3rem;fill:#D2281E}.dashboard-layout .ds-toolbar .group-items-toolbar .box-notifycation .dropdown .menu .menu-item .error{fill:#D2281E}.dashboard-layout .ds-toolbar .group-items-toolbar .box-notifycation .dropdown .menu .menu-item .warning{fill:var(--beyond-secondary-accent-color)}.dashboard-layout .ds-toolbar .group-items-toolbar .box-notifycation .dropdown .menu .menu-item .icon-button{margin-right:.5rem}.dashboard-layout .ds-toolbar .group-items-toolbar .box-notifycation .dropdown .menu .menu-item .icon-button:hover{filter:none}.dashboard-layout .ds-toolbar .group-items-toolbar .box-notifycation .dropdown .menu .menu-item:hover{background-color:#525357}.dashboard-layout .ds-toolbar .group-items-toolbar .box-notifycation .dropdown .menu .menu-item .icon-right{margin-left:auto}.dashboard-layout .ds-toolbar .group-items-toolbar .box-notifycation .dropdown .menu .menu-item .information-notification{display:flex;justify-content:space-between;width:90%;text-transform:capitalize;flex-wrap:wrap;padding-left:1rem}.dashboard-layout .ds-toolbar .group-items-toolbar .box-notifycation .dropdown .menu .menu-item .information-notification .name-archivo{color:#fff}.dashboard-layout .ds-toolbar .group-items-toolbar .box-notifycation .dropdown .menu .menu-item .information-notification .number-line{color:#7fff00}.dashboard-layout .ds-toolbar .group-items-toolbar .box-notifycation .dropdown .menu .menu-item p{text-transform:capitalize;color:#d2281e}.dashboard-layout .ds-toolbar .toolbar__aside__logo{background:url("/images/logo.png") no-repeat center center var(--beyond-secondary-light-color);background-size:50%;width:274px;display:flex;align-items:center;justify-content:center;height:50px}.dashboard-layout.aside-hidden .ds-toolbar .toolbar__aside__logo{width:54px;background-image:url("/images/beyond-iso.png");background-size:35%;overflow:hidden}.dashboard-layout .ds-toolbar .group-items-toolbar .box-notifycation .icon-button{position:relative;display:flex;align-items:center;justify-content:center;width:35px;height:35px;color:#000;background:var(--beyond-border-variant-color);border:none;outline:0;border-radius:50%}.dashboard-layout .ds-toolbar .group-items-toolbar .box-notifycation .icon-button:hover{cursor:pointer}.dashboard-layout .ds-toolbar .group-items-toolbar .box-notifycation .icon-button:active{background:#ccc}.dashboard-layout .ds-toolbar .group-items-toolbar .box-notifycation .icon-button .icon-bell{margin-right:-.5rem}.dashboard-layout .ds-toolbar .group-items-toolbar .box-notifycation .icon-button .icon-button__badge{position:absolute;top:-5px;right:-10px;width:20px;height:20px;background:#d2281e;color:#fff;display:flex;justify-content:center;align-items:center;border-radius:50%}.dashboard-layout .ds-toolbar .group-items-toolbar .box-notifycation .hide{display:none}');
