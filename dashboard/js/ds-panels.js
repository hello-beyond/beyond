define(["exports", "@beyond-js/ui/perfect-scrollbar", "@beyond-js/dashboard-lib/models.legacy", "@beyond-js/dashboard/ds-contexts", "@beyond-js/dashboard/models", "@beyond-js/dashboard-lib/models.ts", "@beyond-js/dashboard/core-components", "@beyond-js/dashboard/hooks", "@beyond-js/dashboard/context-menu", "@beyond-js/dashboard/ds-editor.code", "@beyond-js/kernel/bundle", "react", "react-dom"], function (_exports, _perfectScrollbar, _models, _dsContexts, _models2, _models3, _coreComponents, _hooks, _contextMenu, _dsEditor, dependency_0, dependency_1, dependency_2) {
  "use strict";
  ...
  const __pkg = new __Bundle({
    "module": "@beyond-js/dashboard/ds-panels",
    "bundle": "code"
  }).package();
  ...
  *************/
  ...
  class Panel extends _models.ReactiveModel {
    /**
    ...
    async _openTemplate(board) {
      ...
      const project = await _models2.projectsFactory.get(board.applicationId);
    ...
    async openBoard(board) {
      ...
      const application = await _models2.projectsFactory.get(board.applicationId);
    ...
    createEditor(application, type) {
      const manager = (0, _dsEditor.getEditorManager)(application);
    ...
    async changeTab(tab) {
      ...
      const execute = async ready => {
        ...
        const application = await _models2.projectsFactory.get(tab.applicationId);
  ...
  **************/
  ...
  class PanelsManager extends _models.ReactiveModel {
    #boards;
  ...
  ***********/
  ...
  function TabIcon({
    ...
    if (item.type !== 'editor') {
      ...
      icon = _coreComponents.DS_ICONS.hasOwnProperty(name) ? name : icon;
    }

    window.ds = _coreComponents.DS_ICONS;

    if (item.type === 'editor') {
      icon = _coreComponents.DS_ICONS.hasOwnProperty(`processor.${item.processor}`) ? `file.${item.processor}` : 'code';
    }
  ...
  ******/
  ...
  function PanelTab({
    ...
    const {
      addPanel
    } = (0, _dsContexts.useWorkspacePanelsContext)();
    ...
    (0, _hooks.useBinder)([contextMenu], openContextMenu, 'fired.tab');
    (0, _hooks.useBinder)([contextMenu], () => toggleContextMenu(false), 'closed');
    (0, _hooks.useBinder)([panel], () => setName(panel.tabs.get(id).label), `tab.change.${id}`);
    (0, _hooks.useBinder)([panel, panel.editor], () => {
    ...
    return /*#__PURE__*/React.createElement("div", _extends({
      ...
      item: item
    }), name, /*#__PURE__*/React.createElement(IconTab, null), showContextMenu && /*#__PURE__*/React.createElement(_contextMenu.DSContextMenu, {
      unmount: toggleContextMenu,
      specs: showContextMenu
    }, /*#__PURE__*/React.createElement("ul", null, /*#__PURE__*/React.createElement(_contextMenu.ItemMenu, {
      onClick: addPanel,
      icon: "splitView",
      label: texts.actions.splitRight
    }), /*#__PURE__*/React.createElement(_contextMenu.ItemMenu, {
      onClick: onClose,
      icon: "splitView",
  ...
  ********/
  ...
  function PanelView({
    ...
    const Control = tab.type === 'editor' ? _dsEditor.EditorView : tab.control;
    const tabs = [];
    ...
    }, tabs), /*#__PURE__*/React.createElement(_perfectScrollbar.BeyondScrollContainer, {
  ...
  *********/
  ...
  function Panels() {
    ...
    return /*#__PURE__*/React.createElement(_dsContexts.WorkspacePanelsContext.Provider, {
      value: {
        addPanel,
        panels: panels,
        panel: panels.active
  ...
  **********/
  ...
  function Preload() {
    ...
    }, "\xA0\xA0 \xA0\xA0 \xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0")), /*#__PURE__*/React.createElement(_perfectScrollbar.BeyondScrollContainer, {
      className: "panel__container"
