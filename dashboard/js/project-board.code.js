define(["exports", "@beyond-js/dashboard-lib/models.legacy", "@beyond-js/ui/form", "@beyond-js/ui/image", "@beyond-js/ui/icon", "@beyond-js/ui/popover", "@beyond-js/ui/spinner", "@beyond-js/ui/preload-text", "@beyond-js/ui/modal", "@beyond-js/dashboard/hooks", "@beyond-js/dashboard/models", "@beyond-js/dashboard/tooltip", "@beyond-js/dashboard/uploader-workspace", "@beyond-js/dashboard/ds-editor.code", "@beyond-js/dashboard/core-components", "@beyond-js/dashboard/context-menu", "@beyond-js/dashboard/ds-contexts", "@beyond-js/kernel/texts", "@beyond-js/kernel/bundle", "react", "react-dom"], function (_exports, _models, _form, _image, _icon, _popover, _spinner, _preloadText, _modal, _hooks, _models2, _tooltip, _uploaderWorkspace, _dsEditor, _coreComponents, _contextMenu, _dsContexts, _texts, dependency_0, dependency_1, dependency_2) {
  "use strict";
  ...
  ******************/
  ...
  const controller = new class Controller extends _models.ReactiveModel {
    #workspace;
    #application;
    ...
    get ready() {
      const dependencies = !!this.#texts.ready && !!_dsEditor.monacoDependency?.ready;
      const models = !!this.application?.ready && !!_models2.DSModel.ready;
    ...
    start(workspace, appId, moduleId, element) {
      ...
      _dsEditor.monacoDependency.bind('change', this.triggerEvent);
  ...
  ****************************/
  ...
  function DSProcessButton({
    ...
    return /*#__PURE__*/React.createElement(_coreComponents.DSIconButton, {
      onClick: action,
      icon: icon,
      className: className,
      title: title
  ...
  *********************/
  ...
  function ApplicationConfig() {
    ...
    (0, _hooks.useBinder)([model, declarations], () => setState({}));
    ...
    }, !declarations.processing ? /*#__PURE__*/React.createElement(React.Fragment, null, actions.declarations) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_spinner.BeyondSpinner, {
  ...
  function EditField({
    ...
    if (edit) {
      return /*#__PURE__*/React.createElement("div", {
        ...
        name: field,
        defaultValue: value
      }), /*#__PURE__*/React.createElement(_coreComponents.FadeIn, null, /*#__PURE__*/React.createElement("div", {
        className: "form__actions"
      }, /*#__PURE__*/React.createElement(_form.BeyondButton, {
        className: "btn primary",
        type: "submit"
      }, texts.actions.save), /*#__PURE__*/React.createElement(_form.BeyondButton, {
  ...
  **************/
  ...
  function BeeActions({
    ...
    (0, _hooks.useBinder)([bee], () => {
      const fetching = ["initialising", "stopping"].includes(bee.status);
    ...
    return /*#__PURE__*/React.createElement(_coreComponents.DSIconButton, _extends({
      onClick: onClick
    }, attrs));
  }
  /*******
  ...
  ********/
  ...
  function ApplicationBoard(props) {
    ...
    return /*#__PURE__*/React.createElement(_dsContexts.AppContext.Provider, {
      value: value
    }, /*#__PURE__*/React.createElement("div", {
      className: "ds__board"
  ...
  *********/
  ...
  function Header() {
    ...
    (0, _hooks.useBinder)([model, declarations], () => setState({}));
    (0, _hooks.useBinder)([application.moduleManager], () => setProcessed(application.moduleManager.processed));
  ...
  *************/
  ...
  function Empty({
    ...
    }, texts.actions.add, /*#__PURE__*/React.createElement(_coreComponents.DashboardIcon, {
      icon: "add",
      className: "circle"
    })));
  }
  ...
  ********************************/
  ...
  function ContainersFilter() {
    ...
    }, /*#__PURE__*/React.createElement("span", null, container), /*#__PURE__*/React.createElement(_icon.BeyondIconButton, {
      icon: "expandMore",
      className: "circle"
    }), /*#__PURE__*/React.createElement("div", {
      ref: containerRef,
  ...
  ***************************/
  ...
  function ItemDeleteAction({
    ...
    return /*#__PURE__*/React.createElement(_modal.BeyondConfirmModal, {
      show: true,
  ...
  **********************/
  ...
  function GridItem({
    ...
    }, !!warnings.length && /*#__PURE__*/React.createElement(_coreComponents.DSIcon, {
      icon: "warning",
      className: "icon icon--warning"
    }), !!errors.length && /*#__PURE__*/React.createElement(_coreComponents.DSIcon, {
      icon: "error",
  ...
  *****************/
  ...
  function Item({
    ...
    }, !!warnings.length && /*#__PURE__*/React.createElement(_coreComponents.DashboardIcon, {
      icon: "warning",
      className: "warning-icon"
    }), !!errors.length && /*#__PURE__*/React.createElement(_coreComponents.DashboardIcon, {
      icon: "error",
  ...
  ************/
  ...
  function ModulesList() {
    ...
    (0, _hooks.useBinder)([application], () => setItems(application?.items));
    if (!application) return null;
  ...
  ************/
  ...
  function Preloader() {
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "board__header"
    }, /*#__PURE__*/React.createElement("header", null, /*#__PURE__*/React.createElement("h2", null, /*#__PURE__*/React.createElement(_preloadText.BeyondPreloadText, {
      height: "17px",
      width: "50px"
    })), /*#__PURE__*/React.createElement("span", {
      className: "pathname"
    }, /*#__PURE__*/React.createElement(_preloadText.BeyondPreloadText, {
      height: "7px",
      width: "150px"
    }))), /*#__PURE__*/React.createElement("div", {
      className: "board__header__actions flex-center flex-container"
  ...
  *****************/
  ...
  function StaticActions() {
    ...
    }, /*#__PURE__*/React.createElement("ul", null, /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement(_icon.BeyondIconButton, {
      "data-title": "delete",
      icon: "delete",
      onClick: onDelete
    })))), state.confirm && /*#__PURE__*/React.createElement(_modal.BeyondConfirmModal, {
      show: true,
      className: "xs ds-modal",
      onConfirm: onConfirm,
      text: "Cambiar texto",
  ...
  ***************/
  ...
  function StaticAside() {
    ...
    }, /*#__PURE__*/React.createElement("ul", null, /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement(_image.BeyondImage, {
  ...
  ***************/
  ...
  function StaticBoard({
    ...
    return /*#__PURE__*/React.createElement(StaticContext.Provider, {
      ...
      type: type
    }), /*#__PURE__*/React.createElement("main", null, /*#__PURE__*/React.createElement(StaticAside, null), /*#__PURE__*/React.createElement("section", null, /*#__PURE__*/React.createElement(_image.BeyondImage, {
      src: source
  ...
  **************************/
  ...
  function StaticOverwrite() {
    ...
    if (src) return /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement(_image.BeyondImage, {
      src: src
    }));
    ...
    return /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement(_uploaderWorkspace.Uploader, {
      url: "/uploader",
      specs: specs,
      multiple: true,
