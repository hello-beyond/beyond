define(["exports", "@beyond-js/dashboard/breadcrumb.code", "@beyond-js/dashboard-lib/models.legacy", "@beyond-js/ui/alert", "@beyond-js/ui/form", "@beyond-js/ui/modal", "@beyond-js/ui/spinner", "@beyond-js/dashboard/ds-contexts", "@beyond-js/dashboard/hooks", "@beyond-js/dashboard/models", "@beyond-js/dashboard/core-components", "@beyond-js/kernel/texts", "@beyond-js/kernel/bundle", "react", "react-dom"], function (_exports, _breadcrumb, _models, _alert, _form, _modal, _spinner, _dsContexts, _hooks, _models2, _coreComponents, _texts, dependency_0, dependency_1, dependency_2) {
  "use strict";
  ...
  ********/
  ...
  function CompileBoard(props) {
    ...
    if (!ready || props.specs.projectId !== controller.application?.id) return /*#__PURE__*/React.createElement(_coreComponents.DsFetchingBlock, null);
    const {
      texts,
      application,
      error
    ...
    }, /*#__PURE__*/React.createElement(_coreComponents.DSBoard, {
  ...
  **************/
  ...
  function Compilation() {
    ...
    (0, _hooks.useBinder)([application.builder], () => {
  ...
  ***********/
  ...
  function Finished() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: "pd-base"
    }, /*#__PURE__*/React.createElement(_alert.BeyondAlert, {
      type: type
  ...
  *******/
  ...
  const DistributionItem = ({
    ...
    return /*#__PURE__*/React.createElement("li", attrs, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h5", null, data.name), /*#__PURE__*/React.createElement("div", {
      ...
      className: "badge"
    }, texts.ssr)), /*#__PURE__*/React.createElement(_coreComponents.DSIcon, {
      icon: "check"
    })));
  };
  /********
  ...
  ******************/
  ...
  const controller = new class extends _models.ReactiveModel {
    #texts;
    ...
    async getApp(id) {
      const application = await _models2.projectsFactory.get(id);
