define(["exports", "emmet-monaco-es", "@beyond-js/dashboard/core-components", "@beyond-js/dashboard-lib/models.legacy", "@beyond-js/dashboard/ds-contexts", "@beyond-js/dashboard/hooks", "@beyond-js/kernel/bundle", "react", "react-dom"], function (_exports, _emmetMonacoEs, _coreComponents, _models, _dsContexts, _hooks, dependency_0, dependency_1, dependency_2) {
  "use strict";
  ...
  const __pkg = new __Bundle({
    "module": "@beyond-js/dashboard/ds-editor",
    "multibundle": true,
    "bundle": "code"
  }).package();
...
`;
  ...
  ******************/
  ...
  class MonacoDependency extends _models.ReactiveModel {
    #promise;
    #monaco;
  ...
  **************/
  ...
  class Editor extends _models.ReactiveModel {
    #type;
    /**
  ...
  ***************/
  ...
  class Manager extends _models.ReactiveModel {
    /**
  ...
  **************/
  ...
  class Models extends _models.ReactiveModel {
  ...
  ****************/
  ...
  class Settings extends _models.ReactiveModel {
    /**
  ...
  *********/
  ...
  function EditorView(props) {
    ...
    (0, _hooks.useBinder)([editor], () => setIsUnpublished(editor.unpublished));
    React.useEffect(() => {
