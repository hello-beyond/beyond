  ...
  ************/
  ...
  window.beyond.phonegap.push = new function () {
    ...
    function onNotification(data) {
      ...
      if (additional && additional.navigate_url && !additional.foreground && (additional.dismissed !== undefined || additional.coldstart || iOS)) {
    ...
    const initialise = async function () {
      ...
      if (typeof PushNotification !== 'object' || !beyond.params.pushNotifications || !beyond.params.pushNotifications.senderID) return;
      const config = {
        'android': {
