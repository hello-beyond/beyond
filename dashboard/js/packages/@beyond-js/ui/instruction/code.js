define(["exports", "react", "react-dom", "/libraries/beyond-ui/form/code"], function (_exports, React, ReactDOM, _code) {
  "use strict";
  ...
  const bundle = beyond.bundles.obtain('@beyond-js/ui/instruction/code', false, {});
  const {
    container
  } = bundle;
