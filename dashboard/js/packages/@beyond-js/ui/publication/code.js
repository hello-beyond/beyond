define(["exports", "react", "react-dom", "@beyond-js/ui/image/code", "@beyond-js/ui/swiper/code", "@beyond-js/ui/video-player/code", "@beyond-js/ui/icon/code"], function (_exports, React, ReactDOM, _code, _code2, _code3, _code4) {
  "use strict";
  ...
  const bundle = beyond.bundles.obtain('@beyond-js/ui/publication/code', false, {});
  const {
    container
  } = bundle;
