define(["exports", "react", "react-dom"], function (_exports, dependency_0, dependency_1) {
  ...
  const __pkg = new __Bundle("@beyond-js/ui/video-player/code").package();
  ...
  **********/
  ...
  const legacyStyles = beyondLegacyStyles.register('@beyond-js/ui/video-player/code', '.beyond-element-video-player{width:100%}.beyond-element-video-player.youtube{position:relative;padding-bottom:56.25%;padding-top:30px;height:0;overflow:hidden}.beyond-element-video-player.youtube embed,.beyond-element-video-player.youtube iframe,.beyond-element-video-player.youtube object{position:absolute;top:0;left:0;width:100%;height:100%}');
