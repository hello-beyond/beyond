define(["exports", "react", "react-dom"], function (_exports, dependency_0, dependency_1) {
  ...
  const __pkg = new __Bundle("@beyond-js/ui/unnamed/libs/popper/page/page").package();
  ...
  **********/
  ...
  const legacyStyles = beyondLegacyStyles.register('@beyond-js/ui/unnamed/libs/popper/page/page', '.beyond-ui-page.popper__page .tooltip{background:#333;color:#fff;font-weight:700;padding:4px 8px;font-size:13px;border-radius:4px;display:none}.beyond-ui-page.popper__page .tooltip[data-show]{display:block}');
