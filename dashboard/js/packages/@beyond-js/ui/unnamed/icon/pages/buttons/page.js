define(["exports", "react", "react-dom", "@beyond-js/ui/icon/code", "@beyond-js/ui/import/code"], function (_exports, React, ReactDOM, _code, _code2) {
  "use strict";
  ...
  const bundle = beyond.bundles.obtain('@beyond-js/ui/unnamed/icon/pages/buttons/page', false, {});
  const {
    container
  } = bundle;
