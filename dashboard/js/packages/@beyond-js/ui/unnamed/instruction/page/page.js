define(["exports", "react", "react-dom", "/libraries/beyond-ui/instruction/code", "/libraries/beyond-ui/import/code"], function (_exports, React, ReactDOM, _code, _code2) {
  "use strict";
  ...
  const bundle = beyond.bundles.obtain('@beyond-js/ui/unnamed/instruction/page/page', false, {});
  const {
    container
  } = bundle;
