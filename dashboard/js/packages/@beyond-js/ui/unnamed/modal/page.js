define(["exports", "@beyond-js/ui/modal", "@beyond-js/ui/form", "@beyond-js/ui/import", "@beyond-js/kernel/bundle", "react", "react-dom"], function (_exports, _modal, _form, _import, dependency_0, dependency_1, dependency_2) {
  "use strict";
  ...
  const __pkg = new __Bundle({
    "module": "@beyond-js/ui/unnamed/modal/page",
    "bundle": "page"
  }).package();
  ...
  class PageView extends React.Component {
    ...
    render() {
      ...
      return /*#__PURE__*/React.createElement("main", {
        ...
        ref: this.textarea
      }), /*#__PURE__*/React.createElement("h2", null, "Custom Modal"), /*#__PURE__*/React.createElement(_import.BeyondImport, {
        name: "BeyondModal",
        route: "/libraries/beyond-ui/modal.js"
      }), /*#__PURE__*/React.createElement("span", {
        className: "text-muted"
      }, "Example: "), /*#__PURE__*/React.createElement("pre", null, '<BeyondModal className="cls">{content}</BeyondModal>'), /*#__PURE__*/React.createElement(_form.BeyondButton, {
        onClick: () => this.open()
      }, "Abrir"), /*#__PURE__*/React.createElement(_form.BeyondButton, {
        onClick: () => this.open('md')
      }, "Abrir Mediano"), /*#__PURE__*/React.createElement(_form.BeyondButton, {
        onClick: () => this.open('lg')
      }, "Abrir Grande"), /*#__PURE__*/React.createElement("hr", null), /*#__PURE__*/React.createElement("h2", null, "Alert Modal"), /*#__PURE__*/React.createElement(_import.BeyondImport, {
        name: "BeyondAlertModal",
        route: "/libraries/beyond-ui/modal.js"
      }), /*#__PURE__*/React.createElement("span", {
        className: "text-muted"
      }, "Example: "), /*#__PURE__*/React.createElement("pre", null, '<BeyondAlertModal ref={this.alert} text="Esto es un alert"/>'), /*#__PURE__*/React.createElement(_form.BeyondButton, {
        onClick: () => this.openAlert()
      }, "Alert"), /*#__PURE__*/React.createElement(_form.BeyondButton, {
        onClick: () => this.openAlert('centered')
      }, "Alert centrado"), /*#__PURE__*/React.createElement("hr", null), /*#__PURE__*/React.createElement("h2", null, "Confirmation Modal"), /*#__PURE__*/React.createElement(_import.BeyondImport, {
        name: "BeyondConfirmModal",
        route: "/libraries/beyond-ui/modal.js"
      }), /*#__PURE__*/React.createElement("span", {
        className: "text-muted"
      }, "Example: "), /*#__PURE__*/React.createElement("pre", null, '<BeyondAlertModal ref={this.alert} text="Esto es un confirm" title="title"/>'), /*#__PURE__*/React.createElement(_form.BeyondButton, {
        onClick: () => this.openConfirm()
      }, "Confirm"), /*#__PURE__*/React.createElement(_form.BeyondButton, {
        onClick: () => this.openConfirm()
      }, "Confirm Centrado"), /*#__PURE__*/React.createElement(_modal.BeyondAlertModal, {
        ref: this.alert,
        text: "Esto es un alert"
      }), /*#__PURE__*/React.createElement(_modal.BeyondAlertModal, {
        ref: this.alertCentered,
        centered: true,
        title: "Esto es un alert centrado"
      }), /*#__PURE__*/React.createElement(_modal.BeyondConfirmModal, {
        ref: this.confirm,
        text: "Esto es un alert",
  ...
  **********/
  ...
  const legacyStyles = beyondLegacyStyles.register('@beyond-js/ui/unnamed/modal/page', '#beyond-ui-dialogs-page textarea{display:none}#beyond-ui-dialogs-page span{display:grid}#beyond-ui-dialogs-page button{margin-right:5px}#beyond-ui-dialogs-page pre{margin:20px 0;padding:15px;position:relative;transition:all .1s ease-in-out;cursor:pointer}#beyond-ui-dialogs-page pre:hover{background:#ff8056;color:#fff;transition:all .1s ease-in}#beyond-ui-dialogs-page pre:before{content:"Copy";position:absolute;padding:15px 20px;top:0;right:0;background:#333;color:#e4e5dc}');
