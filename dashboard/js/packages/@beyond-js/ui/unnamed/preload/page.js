define(["exports", "@beyond-js/ui/empty", "@beyond-js/ui/form", "@beyond-js/ui/import", "@beyond-js/kernel/bundle", "react", "react-dom"], function (_exports, _empty, _form, _import, dependency_0, dependency_1, dependency_2) {
  ...
  _exports.Page = Page;
  _exports.hmr = void 0;
  `import {BeyondPreload} from '@beyond-js/ui/preload';`;
  const {
    Bundle: __Bundle,
    externals
  } = dependency_0;
  ...
  const __pkg = new __Bundle({
    "module": "@beyond-js/ui/unnamed/preload/page",
    "bundle": "page"
  }).package();
  ...
  **************/
  ...
  class Control extends React.Component {
    ...
    render() {
      ...
      }, /*#__PURE__*/React.createElement("h2", null, "Preload"), /*#__PURE__*/React.createElement(_import.BeyondImport, {
