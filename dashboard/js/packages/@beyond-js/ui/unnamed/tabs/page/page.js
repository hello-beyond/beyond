define(["exports", "react", "react-dom", "@beyond-js/ui/empty/code", "@beyond-js/ui/import/code", "@beyond-js/ui/icon/code", "@beyond-js/ui/ripple/code", "@beyond-js/ui/tabs/code"], function (_exports, React, ReactDOM, _code, _code2, _code3, _code4, _code5) {
  "use strict";
  ...
  const bundle = beyond.bundles.obtain('@beyond-js/ui/unnamed/tabs/page/page', false, {});
  const {
    container
  } = bundle;
