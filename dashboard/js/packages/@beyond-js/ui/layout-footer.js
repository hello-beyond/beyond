define(["exports", "@beyond-js/ui/image", "@beyond-js/ui/icon", "@beyond-js/kernel/bundle", "react", "react-dom"], function (_exports, _image, _icon, dependency_0, dependency_1, dependency_2) {
  "use strict";
  ...
  const __pkg = new __Bundle({
    "module": "@beyond-js/ui/layout-footer",
    "bundle": "code"
  }).package();
