define(["exports", "react", "react-dom", "@beyond-js/ui/ripple/code"], function (_exports, React, ReactDOM, _code) {
  ...
  const bundle = beyond.bundles.obtain('@beyond-js/ui/form/code', false, {});
  const {
    container
  } = bundle;
