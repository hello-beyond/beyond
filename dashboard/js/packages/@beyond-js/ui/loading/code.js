define(["exports", "/libraries/beyond-ui/spinner/code", "react", "react-dom"], function (_exports, _code, dependency_0, dependency_1) {
  ...
  const __pkg = new __Bundle("@beyond-js/ui/loading/code").package();
