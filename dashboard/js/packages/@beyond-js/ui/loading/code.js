define(["exports", "react", "react-dom", "/libraries/beyond-ui/spinner/code"], function (_exports, React, ReactDOM, _code) {
  "use strict";
  ...
  const bundle = beyond.bundles.obtain('@beyond-js/ui/loading/code', false, {});
  const {
    container
  } = bundle;
