define(["exports", "@beyond-js/ui/image", "@beyond-js/ui/form", "@beyond-js/ui/icon", "/components/core", "/libraries/beyond-dashboard/ui/layout/search", "@beyond-js/ui/modal", "@beyond-js/kernel/bundle", "react", "react-dom"], function (_exports, _image, _form, _icon, _core, _search, _modal, dependency_0, dependency_1, dependency_2) {
  "use strict";
  ...
  const __pkg = new __Bundle({
    "module": "@beyond-js/ui/layout-toolbar",
    "bundle": "code"
  }).package();
  ...
  **********/
  ...
  const legacyStyles = beyondLegacyStyles.register('@beyond-js/ui/layout-toolbar', '.ds-toolbar{display:flex;position:sticky;align-items:center;justify-content:center;height:60px;top:0;transition:all .3s ease-in;background:#0c1423;z-index:2;box-shadow:0 5px 5px -5px #333}.ds-toolbar .beyond-element-image.app-logo{height:70%;padding:0;margin:0}.ds-toolbar .beyond-element-image.app-logo img{height:100%}');
