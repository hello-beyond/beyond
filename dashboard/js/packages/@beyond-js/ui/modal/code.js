define(["exports", "react", "react-dom", "@beyond-js/ui/icon/code", "@beyond-js/ui/form/code"], function (_exports, React, ReactDOM, _code, _code2) {
  "use strict";
  ...
  const bundle = beyond.bundles.obtain('@beyond-js/ui/modal/code', false, {});
  const {
    container
  } = bundle;
