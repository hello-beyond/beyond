define(["exports", "@beyond-js/ui/icon/code", "@beyond-js/ui/form/code", "react", "react-dom"], function (_exports, _code, _code2, dependency_0, dependency_1) {
  ...
  const __pkg = new __Bundle("@beyond-js/ui/modal/code").package();
