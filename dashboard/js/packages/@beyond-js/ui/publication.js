define(["exports", "@beyond-js/ui/image", "@beyond-js/ui/swiper", "@beyond-js/ui/video-player", "@beyond-js/ui/icon", "@beyond-js/kernel/bundle", "react", "react-dom"], function (_exports, _image, _swiper, _videoPlayer, _icon, dependency_0, dependency_1, dependency_2) {
  "use strict";
  ...
  const __pkg = new __Bundle({
    "module": "@beyond-js/ui/publication",
    "bundle": "code"
  }).package();
  ...
  *************************/
  ...
  class TrashBeyondPublication extends React.Component {
    ...
    render() {
      ...
      }, graph.picture && graph.picture.uploaded && /*#__PURE__*/React.createElement(_image.BeyondImage, {
        className: "img-post",
        innerRef: this.image,
  ...
  *********************/
  ...
  function BeyondPublication({
    ...
    }, asset.picture && /*#__PURE__*/React.createElement(_image.BeyondImage, {
      className: "img-post",
      size: '800x600',
  ...
  ********/
  ...
  function Icons({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "icons"
    }, config && config.icons && config.icons.map(icon => /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(_icon.BeyondIconButton, {
      icon: icon.icon,
  ...
  *********************/
  ...
  class OpenGraphYoutube extends React.Component {
    ...
    render() {
      ...
      }, /*#__PURE__*/React.createElement(_videoPlayer.BeyondVideoPlayer, {
        id: "jwvideo",
        type: "youtube",
    ...
    render() {
      ...
      if (openGraph.entity !== 'oglink') {
        if (media && media.images.length > 1) {
          output = /*#__PURE__*/React.createElement(_swiper.BeyondSwiperSlider, {
            entries: media.images,
            analyze: true
          });
        } else {
          output = /*#__PURE__*/React.createElement(_image.BeyondImage, {
            ref: this.image,
        ...
        video ? output = /*#__PURE__*/React.createElement(_videoPlayer.BeyondVideoPlayer, {
          id: "jwvideo",
          url: video.url,
          poster: video.image,
          "video-id": "video-id",
