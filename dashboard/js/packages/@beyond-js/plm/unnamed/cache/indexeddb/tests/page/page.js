define(["exports", "react", "react-dom", "/indexeddb/code.js"], function (_exports, React, ReactDOM, _code) {
  "use strict";
  ...
  const bundle = beyond.bundles.obtain('@beyond-js/plm/unnamed/cache/indexeddb/tests/page/page', false, {});
  const {
    container
  } = bundle;
