define(["exports", "/indexeddb/code.js", "react", "react-dom"], function (_exports2, _code, dependency_0, dependency_1) {
  "use strict";
  ...
  const bundle = beyond.bundles.obtain('@beyond-js/plm/unnamed/cache/indexeddb/tests/page/page', false, {}, dependencies);
  const {
    container
  } = bundle;
