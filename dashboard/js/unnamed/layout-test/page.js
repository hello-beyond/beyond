define(["exports", "react", "react-dom", "@beyond-js/ui/icon/code", "@beyond-js/ui/image/code", "@beyond-js/ui/form/code"], function (_exports, React, ReactDOM, _code, _code2, _code3) {
  "use strict";
