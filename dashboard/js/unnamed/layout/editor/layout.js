define(["exports", "@beyond-js/dashboard-lib/models/js", "@beyond-js/ui/image/code", "@beyond-js/ui/modal/code", "@beyond-js/ui/form/code", "react", "react-dom"], function (_exports, _js, _code, _code2, _code3, dependency_0, dependency_1) {
  ...
  const __pkg = new __Bundle("@beyond-js/dashboard/unnamed/layout/editor/layout").package();
  ...
  **********/
  ...
  const legacyStyles = beyondLegacyStyles.register('@beyond-js/dashboard/unnamed/layout/editor/layout', '.ds-modal.ds-modal-doc .modal-content .img-list{display:flex;gap:15px;justify-content:center}.ds-modal.ds-modal-doc .modal-content .img-list .beyond-element-image img{object-fit:cover;height:50px;width:50px}.ds-layout-editor{min-height:99vh;width:100%;display:grid;grid-template-rows:1fr;transition:all .3s ease-in}.ds-layout-editor.sticky{transition:all .3s ease-in}.ds-layout-editor.sticky .ds-toolbar{background-image:linear-gradient(to right,#030508 0,#121f36 100%);transition:all .3s ease-in}');
