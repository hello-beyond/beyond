define(["exports", "@beyond-js/dashboard-lib/models.legacy", "@beyond-js/dashboard/notify", "@beyond-js/dashboard/layout-toolbar", "@beyond-js/ui/modal", "@beyond-js/ui/form", "@beyond-js/ui/image", "@beyond-js/ui/perfect-scrollbar", "@beyond-js/ui/toast", "@beyond-js/kernel/bundle", "react", "react-dom"], function (_exports, _models, _notify, _layoutToolbar, _modal, _form, _image, _perfectScrollbar, _toast, dependency_0, dependency_1, dependency_2) {
  "use strict";
  ...
  const __pkg = new __Bundle({
    "module": "@beyond-js/dashboard/unnamed/layout/dashboard",
    "bundle": "layout"
  }).package();
  ...
  *********/
  ...
  class Notify extends React.Component {
    constructor(props) {
      super(props);
      this.notify = _notify.NotifyManager;
  ...
  Notify.contextType = _toast.ToastContext;
  /***********
  JS PROCESSOR
  ***********/
