define(["exports", "react", "react-dom", "@beyond-js/dashboard-lib/models/ts", "@beyond-js/dashboard-lib/models/js", "@beyond-js/ui/spinner/code", "@beyond-js/ui/form/code", "@beyond-js/ui/preload-text/code", "@beyond-js/dashboard/unnamed/components/binder/code", "@beyond-js/dashboard/unnamed/components/core/code", "@beyond-js/dashboard/unnamed/workspace/context/code"], function (_exports, React, ReactDOM, _ts, _js, _code, _code2, _code3, _code4, _code5, _code6) {
  ...
  const bundle = beyond.bundles.obtain('@beyond-js/dashboard/unnamed/applications/code', false, {
    "txt": {
      "multilanguage": false
    }
  });
  ...
  **********/
  ...
  function ApplicationActions({
    ...
    const {
      texts
    } = useDSApplicationsContext(); // noinspection JSMethodCanBeStatic
    ...
    return /*#__PURE__*/React.createElement("article", {
      ...
      className: "circle",
      onClick: event => compile(event, 'client', application)
    }), application.bee && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_code5.DashboardIconButton, {
      className: "circle",
      icon: "compileService",
      onClick: compile,
      title: texts.actions.compile
  ...
  *************/
  ...
  function BeeActions({
    ...
    return /*#__PURE__*/React.createElement(_code5.DsIconButton, {
      onClick: onClick,
      icon: action,
      className: cls,
      title: texts[action]
