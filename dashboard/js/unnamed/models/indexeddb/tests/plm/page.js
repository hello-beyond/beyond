define(["exports", "/libraries/plm/cache/indexeddb/code", "react", "react-dom"], function (_exports, _code, dependency_0, dependency_1) {
  "use strict";
  ...
  const __pkg = new __Bundle("@beyond-js/dashboard/unnamed/models/indexeddb/tests/plm/page").package();
  ...
  **********/
  ...
  const legacyStyles = beyondLegacyStyles.register('@beyond-js/dashboard/unnamed/models/indexeddb/tests/plm/page', '');
