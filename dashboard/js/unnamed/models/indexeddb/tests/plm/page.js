define(["exports", "react", "react-dom", "/libraries/plm/cache/indexeddb/code"], function (_exports, React, ReactDOM, _code) {
  "use strict";
  ...
  const bundle = beyond.bundles.obtain('@beyond-js/dashboard/unnamed/models/indexeddb/tests/plm/page', false, {});
  const {
    container
  } = bundle;
