define(["exports", "react", "react-dom", "/indexeddb/code"], function (_exports, React, ReactDOM, _code) {
  "use strict";
  ...
  const bundle = beyond.bundles.obtain('@beyond-js/dashboard/unnamed/models/indexeddb/tests/page/page', false, {});
  const {
    container
  } = bundle;
