define(["exports", "/indexeddb", "@beyond-js/kernel/bundle", "react", "react-dom"], function (_exports, _indexeddb, dependency_0, dependency_1, dependency_2) {
  "use strict";
  ...
  const __pkg = new __Bundle({
    "module": "@beyond-js/dashboard/unnamed/models/indexeddb/tests/page",
    "bundle": "page"
  }).package();
  ...
  **************/
  ...
  function Database() {
    ...
    this.create = async () => {
      await _indexeddb.BeyondDB.delete(config.name);
      db = await _indexeddb.BeyondDB.create(config);
      store = db.store('customers');
      await store.save([{
        'id': 3,
        'name': 'Moises',
  ...
  **********/
  ...
  const legacyStyles = beyondLegacyStyles.register('@beyond-js/dashboard/unnamed/models/indexeddb/tests/page', '');
