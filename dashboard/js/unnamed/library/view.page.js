define(["exports", "@beyond-js/dashboard-lib/models.ts", "@beyond-js/ui/icon", "@beyond-js/ui/perfect-scrollbar", "@beyond-js/dashboard/unnamed/modules/list/page", "@beyond-js/dashboard/core-components", "@beyond-js/ui/form", "@beyond-js/kernel/bundle", "react", "react-dom"], function (_exports, _models, _icon, _perfectScrollbar, _page, _coreComponents, _form, dependency_0, dependency_1, dependency_2) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.ListModules = void 0;
  _exports.Page = Page;
  _exports.hmr = void 0;
  const {
    Bundle: __Bundle,
  ...
  const __pkg = new __Bundle({
    "module": "@beyond-js/dashboard/unnamed/library/view",
    "multibundle": true,
    "bundle": "page"
  }).package();
  ...
  **********/
  ...
  class ApplicationActions extends React.PureComponent {
    ...
    render() {
      ...
      }, /*#__PURE__*/React.createElement("section", null, /*#__PURE__*/React.createElement(_coreComponents.DashboardIconButton, {
      ...
      }), library.connect && /*#__PURE__*/React.createElement(_form.BeyondButton, {
        className: "primary small details",
        onClick: () => actions.compile('client', library)
      }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(_coreComponents.DashboardIcon, {
        icon: "settings"
  ...
  class Excluded extends React.Component {
    ...
    render() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        className: "detail"
      }, /*#__PURE__*/React.createElement(_coreComponents.DashboardIcon, {
        ...
        key: excluded.id
      }, excluded.path)))), /*#__PURE__*/React.createElement(_coreComponents.DashboardIconButton, {
        className: "detail-icon",
        icon: "expandMore"
      }));
    }
  ...
  class Routes extends React.Component {
    ...
    render() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        key: route.id
      }, route.path)))), /*#__PURE__*/React.createElement(_coreComponents.DashboardIconButton, {
        className: "detail-icon",
        icon: "expandMore"
      }));
    }
  ...
  class StaticFiles extends React.Component {
    ...
    render() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        key: statics.id
      }, statics.path)))), /*#__PURE__*/React.createElement(_coreComponents.DashboardIconButton, {
        className: "detail-icon",
        icon: "expandMore"
      }));
    }
  ...
  ******************/
  ...
  function Statics({
    ...
    }, /*#__PURE__*/React.createElement("header", null, /*#__PURE__*/React.createElement(_coreComponents.DashboardIcon, {
      className: "detail-icon",
      name: "archive"
    }), /*#__PURE__*/React.createElement("div", {
      className: "title-content"
    }, /*#__PURE__*/React.createElement("h3", null, texts.titles.static)), /*#__PURE__*/React.createElement(_coreComponents.DashboardIconButton, {
      onClick: () => setOpen(!openCollapse),
      className: "detail-icon",
      icon: icon
    })), /*#__PURE__*/React.createElement(_perfectScrollbar.BeyondScrollContainer, {
      className: "collapse-container"
    }, items));
  }
  /*******************
  ...
  class Templates extends React.Component {
    ...
    render() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        key: template.id
      }, template.path)))), /*#__PURE__*/React.createElement(_coreComponents.DashboardIconButton, {
        className: "detail-icon",
        icon: "expandMore"
      }));
    }
  ...
  *********/
  ...
  function LibraryErrors({
    ...
    if (errors.length) {
      ...
      output.push( /*#__PURE__*/React.createElement(_coreComponents.BeyondAlert, {
  ...
  ******************/
  ...
  _exports.ListModules = ListModules;
  ...
  class Modules extends React.Component {
    ...
    render() {
      ...
      return /*#__PURE__*/React.createElement("section", {
        ...
        className: "description"
      }, "(", count, ") ", texts.elements.count)), /*#__PURE__*/React.createElement(_coreComponents.DashboardIconButton, {
        className: "detail-icon",
        icon: "expandMore"
      }));
    }
  ...
  ************/
  ...
  function Page() {
    const library = new _models.Library({
      identifier: {
  ...
  **********/
  ...
  const legacyStyles = beyondLegacyStyles.register('@beyond-js/dashboard/unnamed/library/view.page', '');
