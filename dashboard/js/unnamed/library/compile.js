define(["exports", "@beyond-js/ui/form", "@beyond-js/dashboard-lib/models.ts", "@beyond-js/ui/perfect-scrollbar", "@beyond-js/kernel/bundle", "react", "react-dom"], function (_exports, _form, _models, _perfectScrollbar, dependency_0, dependency_1, dependency_2) {
  "use strict";
  ...
  const __pkg = new __Bundle({
    "module": "@beyond-js/dashboard/unnamed/library/compile",
    "bundle": "page"
  }).package();
  ...
  *******/
  ...
  class View extends React.Component {
    ...
    render() {
      ...
      }, /*#__PURE__*/React.createElement("h1", null, "Library ", /*#__PURE__*/React.createElement("strong", null, library.name)), /*#__PURE__*/React.createElement("span", null, "Compila tu libreria"), /*#__PURE__*/React.createElement(_form.BeyondButton, {
        className: "primary small",
        onClick: this.handleSubmit
      }, "Compilar")), /*#__PURE__*/React.createElement(_perfectScrollbar.BeyondScrollContainer, {
  ...
  ************/
  ...
  function Page() {
    const library = new _models.Library(this.vdir);
