define(["exports", "react", "react-dom", "@beyond-js/dashboard-lib/models/ts"], function (_exports, React, ReactDOM, _ts) {
  "use strict";
  ...
  const bundle = beyond.bundles.obtain('@beyond-js/dashboard/unnamed/library/modules/page', false, {});
  const {
    container
  } = bundle;
