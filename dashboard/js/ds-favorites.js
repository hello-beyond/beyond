define(["exports", "@beyond-js/dashboard-lib/models.legacy", "@beyond-js/ui/modal", "@beyond-js/ui/spinner", "@beyond-js/ui/form", "@beyond-js/dashboard/hooks", "@beyond-js/dashboard/models", "@beyond-js/dashboard/ds-contexts", "@beyond-js/dashboard/workspace-tree", "@beyond-js/kernel/bundle", "react", "react-dom"], function (_exports, _models, _modal, _spinner, _form, _hooks, _models2, _dsContexts, _workspaceTree, dependency_0, dependency_1, dependency_2) {
  "use strict";
  ...
  const __pkg = new __Bundle({
    "module": "@beyond-js/dashboard/ds-favorites",
    "bundle": "code"
  }).package();
  ...
  ********/
  ...
  function AsideFavorites() {
    ...
    (0, _hooks.useBinder)([favorites], () => setTotalFavorites(favorites.items.size));
    (0, _hooks.useBinder)([favorites], () => setRenamed(performance.now()), 'favorite.renamed');
    ...
    const output = items.map((item, key) => /*#__PURE__*/React.createElement(_workspaceTree.DSTree, {
      key: key,
      object: item,
      title: item.name,
      tree: item.tree
  ...
  **************/
  ...
  function FavoritesRenameForm({
    ...
    } = (0, _workspaceTree.useDSTreeContext)();
  ...
  *************/
  ...
  class FavoritesModel extends _models.ReactiveModel {
    _tree;
    ...
    async _check() {
      ...
      const favorites = await _models2.DSModel.db.store('favorites');
      this._db = favorites;
  ...
  ****************/
  ...
  class FavoriteChildren extends _models.ReactiveModel {
    _bundle;
  ...
  ***************/
  ...
  class Factory extends _models.ReactiveModel {
    _items = new Map();
  ...
  *****************/
  ...
  class FavoritesListBase extends _models.ReactiveModel {
    _name;
  ...
  ************/
  ...
  class FavoritesList extends FavoritesListBase {
    ...
    constructor(parent, moduleManager, {
      ...
      this._store = _models2.DSModel.db.store('favorites');
    ...
    _createTree = () => {
      ...
      this._tree = _workspaceTree.TreeFactory.get('favorites', {
        project: application,
        object: this,
        items,
        id: this.id
