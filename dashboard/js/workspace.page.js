define(["exports", "@beyond-js/ui/image", "@beyond-js/ui/form", "@beyond-js/ui/spinner", "@beyond-js/dashboard-lib/models.ts", "@beyond-js/dashboard/hooks", "@beyond-js/dashboard/core-components", "@beyond-js/dashboard/uploader-components", "@beyond-js/dashboard/breadcrumb.code", "@beyond-js/dashboard/models", "@beyond-js/dashboard/settings.code", "@beyond-js/dashboard/projects-board.code", "@beyond-js/dashboard/project-create.code", "@beyond-js/dashboard/project-compile.code", "@beyond-js/dashboard/project-board.code", "@beyond-js/dashboard/aside.code", "@beyond-js/dashboard/ds-navigator", "@beyond-js/dashboard/ds-panels", "@beyond-js/dashboard/ds-notifications.code", "@beyond-js/dashboard/ds-contexts", "@beyond-js/dashboard/module-view.code", "@beyond-js/dashboard/module-create.code", "@beyond-js/dashboard/layout-header", "@beyond-js/kernel/texts", "@beyond-js/kernel/bundle", "react", "react-dom"], function (_exports, _image, _form, _spinner, _models, _hooks, _coreComponents, _uploaderComponents, _breadcrumb, _models2, _settings, _projectsBoard, _projectCreate, _projectCompile, _projectBoard, _aside, _dsNavigator, _dsPanels, _dsNotifications, _dsContexts, _moduleView, _moduleCreate, _layoutHeader, _texts, dependency_0, dependency_1, dependency_2) {
  "use strict";
  ...
  _exports.Page = Page;
  _exports.hmr = _exports.Workspace = void 0;
  //Beyond  UI
  //Libraries
  //Dashboard
  //  @beyond-js Texts
  ...
  *************/
  ...
  class WorkspaceAside extends _models.ReactiveModel {
    #preaside;
    ...
    removeProjectItems() {
      ...
      _dsContexts.DSPreAside.remove(['application', 'module', 'favorites', 'add', 'template', 'statics']);
    }

    addProjectItems() {
      this.#projectItems = true;

      _dsContexts.DSPreAside.addItems('top', {
        application: {
          action: name => {
      ...
      _dsContexts.DSPreAside.addItems('bottom', {
        add: {
  ...
  ********************/
  ...
  class ContextMenu extends _models.ReactiveModel {
    _event;
  ...
  ************/
  ...
  function Page() {
    (() => {
      _dsContexts.DSBoards.add('application', {
        control: _projectBoard.ApplicationBoard,
        label: 'app'
      });

      _dsContexts.DSBoards.add('applicationConfig', {
        control: _projectBoard.ApplicationConfig,
        label: 'appConfig'
      });

      _dsContexts.DSBoards.add('module', {
        control: _moduleView.ModuleBoard,
        label: 'module'
      });

      _dsContexts.DSBoards.add('static', {
        control: _projectBoard.StaticBoard,
        label: 'static'
      });

      _dsContexts.DSBoards.add('settings', {
        control: _settings.ConfigBoard,
        label: 'settings'
      });

      _dsContexts.DSBoards.add('applications', {
        control: _projectsBoard.ApplicationsBoard,
        label: 'apps'
      });

      _dsContexts.DSBoards.add('navigator', {
        control: _dsNavigator.NavigatorBoard,
        label: 'navigator'
      });

      _dsContexts.DSBoards.add('compile', {
        control: _projectCompile.CompileBoard,
        label: 'compile'
      });
    })();
  ...
  ****************/
  ...
  class UploaderController extends _models.ReactiveModel {
    _uploader;
    ...
    load() {
      const uploader = new _uploaderComponents.JidaUploader({
        type: 'image',
        name: 'images',
        params: {},
    ...
    getInstance(type, item) {
      ...
      const Model = type === 'module' ? _models.ModuleStatic : _models.ApplicationStatic;
  ...
  *****************/
  ...
  const Workspace = class extends _models.ReactiveModel {
    #contextMenu;
    ...
    constructor(specs = {}) {
      super();
      this.#applications = new _models.Applications(TREE.APPS);
      this.#dashboard = _models.Dashboard;
      this.#user = new _models2.DSUser(this.#dashboard);
    ...
    #addNotifications = () => {
      ...
      _dsNotifications.DSNotifications.start(this.applications.items);
    };

    async #load() {
      this.#wd = await _models.Dashboard.getWD();
      await this.#dsmodel.initialise(this.#wd);
      await _models2.DSModel.initialise();
      this.#store = _models2.DSModel.db.store('workspace');
      let data = await this.#store.get(this.#wd);
      const apps = Array.from(data.opened.values());

      if (!!apps.length) {
        const promises = apps.map(id => _models2.projectsFactory.get(id));
        await Promise.all(promises);
      }

      if (data.activeApp) {
        this.#active = await _models2.projectsFactory.get(data.activeApp);
        if (this.#active.application.found) this.#appsOpened.add(data.activeApp);else data = await _models2.DSModel.reset(this.#wd);
      }
      ...
      this.#panels = new _dsPanels.PanelsManager(_dsContexts.DSBoards, this);
    ...
    getApplication(id, moduleId, element) {
      ...
      return _models2.projectsFactory.get(parseInt(id), moduleId, element);
    }

    getProject(id) {
      return _models2.projectsFactory.get(parseInt(id));
    }
  ...
  *************/
  ...
  function AppErrors() {
    ...
    }, !!errors?.length && /*#__PURE__*/React.createElement(_coreComponents.BeyondAlert, {
      type: "error"
    }, /*#__PURE__*/React.createElement("ul", null, errors)), !!warnings?.length && /*#__PURE__*/React.createElement(_coreComponents.BeyondAlert, {
      type: "warning"
  ...
  *****************/
  ...
  function DeveloperForm({
    ...
    }), state.fetching ? /*#__PURE__*/React.createElement(_spinner.BeyondSpinner, {
  ...
  **********/
  ...
  function AppPreload() {
    ...
    }, /*#__PURE__*/React.createElement(Toolbar, null), /*#__PURE__*/React.createElement(_aside.WorspaceAside, null), /*#__PURE__*/React.createElement("div", {
  ...
  *********************/
  ...
  function PreloadCollection({
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, header && /*#__PURE__*/React.createElement(_layoutHeader.DsHeaderBar, null, /*#__PURE__*/React.createElement("header", {
  ...
  ***********************/
  ...
  function PreloadItem() {
    ...
    }, /*#__PURE__*/React.createElement(_coreComponents.DashboardIconButton, {
      icon: "upload",
      className: "circle",
      disabled: true
    }), /*#__PURE__*/React.createElement(_coreComponents.DashboardIconButton, {
  ...
  ******************/
  ...
  const PreloadWelcome = ({
    ...
    (0, _hooks.useBinder)([workspace], onChange);
  ...
  **********/
  ...
  function Toolbar() {
    ...
    }, /*#__PURE__*/React.createElement(_breadcrumb.DsBreadcrumb, {
      items: items
    }), /*#__PURE__*/React.createElement("div", {
      className: "right__panel"
    }, /*#__PURE__*/React.createElement("section", {
      className: " user__label"
    }, user.name), /*#__PURE__*/React.createElement(_dsNotifications.NotificationPanel, null))));
  }
  /************
  workspace.jsx
  ************/
  ...
  function DSWorkspace({
    ...
    (0, _hooks.useBinder)([workspace], () => setState({
      ready: workspace.ready,
      ...workspace.state
    }));
    React.useEffect(() => {
      _dsContexts.DSPreAside.addToTop("projects", {
        icon: 'apps',
        title: 'Projectos',
        tippy: {
          placement: 'right'
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_dsContexts.DSWorkspaceContext.Provider, {
      value: value
    }, /*#__PURE__*/React.createElement("div", {
      className: "ds-application-view-layout"
    }, /*#__PURE__*/React.createElement(Toolbar, null), /*#__PURE__*/React.createElement(AppErrors, null), /*#__PURE__*/React.createElement(_aside.WorspaceAside, null), /*#__PURE__*/React.createElement("div", {
      className: "ds__main-container"
    }, /*#__PURE__*/React.createElement(_dsPanels.Panels, null)), /*#__PURE__*/React.createElement(FooterBar, null))), showModal && /*#__PURE__*/React.createElement(_projectCreate.ApplicationCreate, {
      closeModal: () => setShowModal(false)
    }), state.addModule && /*#__PURE__*/React.createElement(_moduleCreate.CreateModuleForm, {
      workspace: workspace,
